...
;; One turtle represents one cell
turtles-own [
  radius      ;; spherical radius of the cell in micro-meters; varies according to cell growth
  s-radius    ;; radius of the flattened cell in micro-meters, vaires according to cell spreading
  dr          ;; the growing rate (difference in radius in one interation)
  volume      ;; volume of the cell; varies according to cell cycle stage and time
  ...
  ask turtles[
    ...
    [
      ...
      if (cycle-stage = 1) [
        ...
        set dr (( volume * 3 / (4 * pi) ) ^ ( 1 / 3 )) - radius ;; update dr to take into account when spreading
